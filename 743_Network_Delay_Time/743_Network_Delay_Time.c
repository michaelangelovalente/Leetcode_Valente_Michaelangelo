...
int *dijkstra( int start, struct graph *G){
    ...
    int **pq = makePQ( 150); //(start_vrtx, dist/key == 0)
...
;
    ...
    int result = networkDelayTime( test_input, timesSize, &(colSize), 50, 4 );
